$(document).ready(function() {
	...
	// 菜单点击事件绑定
	$('div.menu-control > a').click(function(event) {
...
function menuSwitch(that) {
	...
	case '用户管理':
		// 创建部门管理的tab
		var content = '<iframe scrolling="auto" frameborder="0"  src="userList.jsp" style="width:100%;height:100%;"></iframe>';
		createTab('用户管理', 'user_mg', 'icon-user', content);
		break;
	case '书籍管理':
		// 创建书籍管理的tab
		var content = '<iframe scrolling="auto" frameborder="0"  src="bookList.jsp" style="width:100%;height:100%;"></iframe>';
		createTab('书籍管理', 'book_mg', 'icon-book', content);
		break;
	case '借书管理':
		// 创建借书管理的tab
		var content = '<iframe scrolling="auto" frameborder="0"  src="rentBook.jsp" style="width:100%;height:100%;"></iframe>';
		createTab('借书管理', 'rentBook_mg', 'icon-book_rent', content);
		break;
	case '还书管理':
		// 创建借书管理的tab
		var content = '<iframe scrolling="auto" frameborder="0"  src="returnBook.jsp" style="width:100%;height:100%;"></iframe>';
