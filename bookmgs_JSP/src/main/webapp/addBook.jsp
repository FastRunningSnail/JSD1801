...
<body>
	...
	<form id="bookForm" action="BookServlet" method="post"
		...
		<div class="form-control">
			<input id="bid" name="name" value="${bookInfo.bid }" />*必须
		</div>
		<div class="form-control">
		...
		<%-- <div class="form-control">
			<input id="thumbnail" name="thumbnail" value="${bookInfo.thumbnail }" />*必须
		</div> --%>
		<div class="form-control">
			<input id="status" name="status" value="${bookInfo.status }" />*必须
		</div>
		</div>
		<div class="form-control ">
			<a href="javascript:void(0);" class="easyui-linkbutton"
				style="width: 300px; text-align: center;" onclick="addBook();">提&emsp;交</a>
		</div>
	</form>
</body>
</html>