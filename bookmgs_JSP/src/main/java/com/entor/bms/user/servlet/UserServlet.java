...
public class UserServlet extends HttpServlet {
	...
	// 上传文件存储目录
	private static final String UPLOAD_DIRECTORY = "D:\\JSD1801\\liujunpeng\\server\\upload";
	...
	private void batchDel(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		LOGGER.info("batchDel() -> uids = {}", Arrays.toString(request.getParameterValues("uids")));
