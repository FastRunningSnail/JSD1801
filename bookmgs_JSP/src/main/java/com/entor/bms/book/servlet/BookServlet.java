...
public class BookServlet extends HttpServlet {
	...
	// 上传文件存储目录
	private static final String UPLOAD_DIRECTORY = "D:\\JSD1801\\liujunpeng\\server\\img\\books";
	...
	private void returnBook(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		LOGGER.info("",request.getParameter("uid"));
		...
		if(bookInfo == null){
			out.write("{\"success\":false,\"msg\":\"该书已经下架，请找管理员进行人工还书！\"}");
			out.flush();
		}
		bookService.returnBook(Integer.parseInt(request.getParameter("bid")),userInfo);
		out.write("{\"success\":false,\"msg\":\"还书成功！\"}");
	}
...
//		LOGGER.info("froze() invoked！");
	 ...
	 * @throws IOException
	 */
	private void onSale(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
//		LOGGER.info("grounding() invoked！");
	...
	private void update(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println(info.getBid());
		...
		bookInfo.setAmount(info.getAmount());
	 ...
	 * @throws IOException
	 */
	private void batchDele(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
