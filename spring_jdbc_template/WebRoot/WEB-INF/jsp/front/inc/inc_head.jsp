...
<nav id="top">
				...
				<div class="col-xs-12">
					<ul class="top-link">
						...
						<c:if test="${customerBean!=null }">
					    	...
					    	<li><a href="${ctx }/front/liuyan.html">我的留言</a></li>
					    	<li><a href="${ctx }/front/wddz.html">我的地址</a></li>
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo" style="font-size: 30px;">微信电商平台</div>
			</div>
			<div class="col-md-4">
				<form class="form-search" id="abc">  
					<input type="text" class="input-medium search-query" name="productName" placeholder="模糊搜索商品名称">  
			...
			<div class="col-md-4">
				<div id="cart"><a class="btn btn-1" href="shopcar.html"><span class="glyphicon glyphicon-shopping-cart"></span>我的购物车</a></div>
