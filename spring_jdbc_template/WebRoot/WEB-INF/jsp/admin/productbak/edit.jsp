...
<input class="text" type="hidden" name="productPic" id="bbbbbImg0" value="${map.productPic }">
<c:if test="${map.productPic!=null }">
<img style='width:100px;' src="${ctx }/${map.productPic}" id="aaaaaImg0"/>
</c:if>
</td>
</tr>
<tr height="25">
