...
<div class="login-container">
	...
	<form action="" method="post" id="login_form">
		...
		<button id="submit" onclick="loginCheck();" type="button">登陆保存</button>
			...
			<button type="button" class="register-tis">普通员工注册</button>
			</a>
			 --%>
	</form>
	<form action="" method="post" id="registerFormcustomer" style="display: none;">
		...
		<div>
<input type="text" class="username" placeholder="姓名" id="name" name="name"/>
		</div>
		<div>
<select class="username" id="sex" name="sex">
		...
		<div>
<input type="text" class="username" placeholder="地址" id="address" name="address"/>
		</div>
		<div>
<input type="text" class="username" placeholder="手机" id="mobile" name="mobile"/>
		</div>
...
<input type="text" class="username" placeholder="姓名" id="name" name="name"/>
		...
		<div>
<input type="text" class="username" placeholder="工号" id="gh" name="gh"/>
		</div>
		<div>
<input type="text" class="username" placeholder="手机" id="mobile" name="mobile"/>
		</div>
