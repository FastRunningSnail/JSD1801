...
public class RegisterAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		}else if (action_flag.equals("updateCheckImage")) {
			updateCheckImage(request, response);
		}

	}
	
	private void updateCheckImage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String path = request.getContextPath();
		String checkImage = request.getParameter("checkImage");
		String studentId = request.getParameter("studentId");
		List<Object> params = new ArrayList<Object>();
		params.add(checkImage);
		params.add(studentId);
		boolean flag = registerDao.updateUpdateImage(params);
		if (flag) {
	...
	private void updatePswd(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String pswd = request.getParameter("stuPswd");
