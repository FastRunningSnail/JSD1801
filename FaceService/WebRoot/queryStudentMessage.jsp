		...
		<table class="tablelist">
			...
			<tbody>
				...
				<tr>
					...
					%>
					<img style="padding: 10" height="100" width="100" src="<%="http://192.168.43.205:8080/kaoshi/upload/"+map.get("studentImage")%>"/>
					...
					<%
					if(!map.get("checkImage").toString().equals("0")){
					%>
					<img style="padding: 10" height="100" width="100" src="<%="http://192.168.1.168:1010/kaoshi/upload/"+map.get("checkImage")%>"/>
