...
<body>
	...
	<form id="userForm" action="UserServlet" method="post"
		...
		<div class="form-control">
			<input id="name" name="name" value="${userInfo.name }" />*必须
		</div>
		<div class="form-control">
			<input id="password" name="password" value="${userInfo.password }" />*必须
		</div>
		<div class="form-control">
			<input id="idCard" name="idCard" value="${userInfo.idCard }" />*必须
		</div>
		<div class="form-control">
